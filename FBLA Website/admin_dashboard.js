// This script manages the admin dashboard, fetching and displaying reported items with options to verify, delete, or mark as claimed
const container = document.getElementById("itemsContainer");

// Function to fetch all items from Firestore and render them
